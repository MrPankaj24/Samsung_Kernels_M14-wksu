...
export HOSTCFLAGS="--sysroot=$(pwd)/toolchain/build/kernel/build-tools/sysroot \-I$(pwd)/toolchain/prebuilts/kernel-build-tools/linux-x86/include \-isystem /usr/include"
